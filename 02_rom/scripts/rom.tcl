...
#
# rom.tcl: Tcl script for re-creating project 'rom'
#
# Generated by Vivado on Sun Jan 21 13:08:55 +0800 2024
...
#
# 1. This project restoration tcl script (rom.tcl) that was generated.
#
...
#
#    "D:/SoftwareData/Vivado/FPGA_Learning/02_rom/src/hdl/rom.v"
#    "D:/SoftwareData/Vivado/FPGA_Learning/02_rom/src/data/rom_data.coe"
#    "D:/SoftwareData/Vivado/FPGA_Learning/02_rom/src/ip_repo/rom_8x256/rom_8x256.xci"
#    "D:/SoftwareData/Vivado/FPGA_Learning/02_rom/src/ip_repo/d_rom_8x256/d_rom_8x256.xci"
#    "D:/SoftwareData/Vivado/FPGA_Learning/02_rom/src/sim/tb_rom.v"
#
#*****************************************************************************************
...
set files [list \
 [file normalize "${origin_dir}/../src/hdl/rom.v"] \
 [file normalize "${origin_dir}/../src/data/rom_data.coe"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "rom" -objects $obj

# Set 'sources_1' fileset object
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/../src/ip_repo/rom_8x256/rom_8x256.xci"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../src/ip_repo/rom_8x256/rom_8x256.xci"
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/../src/ip_repo/d_rom_8x256/d_rom_8x256.xci"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../src/ip_repo/d_rom_8x256/d_rom_8x256.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
...
set files [list \
 [file normalize "${origin_dir}/../src/sim/tb_rom.v"] \
]
add_files -norecurse -fileset $obj $files
...
set obj [get_filesets sim_1]
set_property -name "top" -value "tb_rom" -objects $obj
