...
#
# dcfifo.tcl: Tcl script for re-creating project 'dcfifo'
#
# Generated by Vivado on Sun Jan 21 23:16:35 +0800 2024
...
#
# 1. This project restoration tcl script (dcfifo.tcl) that was generated.
#
...
#
#    "D:/SoftwareData/Vivado/FPGA_Learning/05_dcfifo/src/hdl/dcfifo.v"
#    "d:/SoftwareData/Vivado/FPGA_Learning/05_dcfifo/src/ip_repo/dcfifo_8x256_to_16x128/dcfifo_8x256_to_16x128.xci"
#    "D:/SoftwareData/Vivado/FPGA_Learning/05_dcfifo/src/sim/tb_dcfifo.v"
#
#*****************************************************************************************
...
set files [list \
 [file normalize "${origin_dir}/../src/hdl/dcfifo.v"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "dcfifo" -objects $obj

# Set 'sources_1' fileset object
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/../src/ip_repo/dcfifo_8x256_to_16x128/dcfifo_8x256_to_16x128.xci"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../src/ip_repo/dcfifo_8x256_to_16x128/dcfifo_8x256_to_16x128.xci"
...
set files [list \
 [file normalize "${origin_dir}/../src/sim/tb_dcfifo.v"] \
]
add_files -norecurse -fileset $obj $files
...
set obj [get_filesets sim_1]
set_property -name "top" -value "tb_dcfifo" -objects $obj
