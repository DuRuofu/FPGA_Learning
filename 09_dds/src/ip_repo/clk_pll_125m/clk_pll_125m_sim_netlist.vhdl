...
entity clk_pll_125m_clk_pll_125m_clk_wiz is
  port (
...
architecture STRUCTURE of clk_pll_125m_clk_pll_125m_clk_wiz is
  signal clk_in_clk_pll_125m : STD_LOGIC;
  signal clk_out_clk_pll_125m : STD_LOGIC;
  signal clkfbout_buf_clk_pll_125m : STD_LOGIC;
  signal clkfbout_clk_pll_125m : STD_LOGIC;
...
plle2_adv_inst: unisim.vcomponents.PLLE2_ADV
    generic map(
      ...
      STARTUP_WAIT => "FALSE"
        ...
        port map (
      CLKFBIN => clkfbout_buf_clk_pll_125m,
      CLKFBOUT => clkfbout_clk_pll_125m,
      CLKIN1 => clk_in_clk_pll_125m,
      CLKIN2 => '0',
      CLKINSEL => '1',
      CLKOUT0 => clk_out_clk_pll_125m,
...
entity clk_pll_125m is
  ...
  attribute NotValidForBitStream of clk_pll_125m : entity is true;
end clk_pll_125m;

architecture STRUCTURE of clk_pll_125m is
begin
inst: entity work.clk_pll_125m_clk_pll_125m_clk_wiz
     port map (
      clk_in => clk_in,
      clk_out => clk_out
    );
