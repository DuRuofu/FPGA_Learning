...
#
# Generated by Vivado on Sun Jan 21 22:28:04 +0800 2024
...
#
#    "D:/SoftwareData/Vivado/FPGA_Learning/04_fifo/src/hdl/scfifo.v"
#    "d:/SoftwareData/Vivado/FPGA_Learning/04_fifo/src/ip_repo/scfifo_8x256/scfifo_8x256.xci"
#    "D:/SoftwareData/Vivado/FPGA_Learning/04_fifo/src/sim/tb_scfifo.v"
#
#*****************************************************************************************
...
set files [list \
 [file normalize "${origin_dir}/../src/hdl/scfifo.v"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "scfifo" -objects $obj

# Set 'sources_1' fileset object
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/../src/ip_repo/scfifo_8x256/scfifo_8x256.xci"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../src/ip_repo/scfifo_8x256/scfifo_8x256.xci"
...
set files [list \
 [file normalize "${origin_dir}/../src/sim/tb_scfifo.v"] \
]
add_files -norecurse -fileset $obj $files
...
set obj [get_filesets sim_1]
set_property -name "top" -value "tb_scfifo" -objects $obj
