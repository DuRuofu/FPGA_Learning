...
#
# Generated by Vivado on Sun Jan 21 16:17:49 +0800 2024
...
#
#    "D:/SoftwareData/Vivado/FPGA_Learning/03_ram/src/hdl/ram.v"
#    "d:/SoftwareData/Vivado/FPGA_Learning/03_ram/src/ip_repo/s_ram_8x256/s_ram_8x256.xci"
#    "d:/SoftwareData/Vivado/FPGA_Learning/03_ram/src/ip_repo/s_d_ram_8x256/s_d_ram_8x256.xci"
#    "d:/SoftwareData/Vivado/FPGA_Learning/03_ram/src/ip_repo/t_d_ram_8x256/t_d_ram_8x256.xci"
#    "D:/SoftwareData/Vivado/FPGA_Learning/03_ram/src/sim/tb_ram.v"
#
#*****************************************************************************************
...
set files [list \
 [file normalize "${origin_dir}/../src/hdl/ram.v"] \
]
...
set obj [get_filesets sources_1]
set_property -name "top" -value "ram" -objects $obj

# Set 'sources_1' fileset object
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/../src/ip_repo/s_ram_8x256/s_ram_8x256.xci"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../src/ip_repo/s_ram_8x256/s_ram_8x256.xci"
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/../src/ip_repo/s_d_ram_8x256/s_d_ram_8x256.xci"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../src/ip_repo/s_d_ram_8x256/s_d_ram_8x256.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
...
set obj [get_filesets sources_1]
set files [list \
 [file normalize "${origin_dir}/../src/ip_repo/t_d_ram_8x256/t_d_ram_8x256.xci"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/../src/ip_repo/t_d_ram_8x256/t_d_ram_8x256.xci"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "generate_files_for_reference" -value "0" -objects $file_obj
set_property -name "registered_with_manager" -value "1" -objects $file_obj
...
set files [list \
 [file normalize "${origin_dir}/../src/sim/tb_ram.v"] \
]
add_files -norecurse -fileset $obj $files
...
set obj [get_filesets sim_1]
set_property -name "top" -value "tb_ram" -objects $obj
